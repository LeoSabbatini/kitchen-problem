...
public class PratoController {
    ...
    @PostMapping
    public ResponseEntity<Prato> criar( @Valid @RequestBody CriarPratoDTO dto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Prato> atualizar(@PathVariable Long id, @Valid @RequestBody CriarPratoDTO prato) {
    ...
    public ResponseEntity<Prato>disponivel(@PathVariable Long id){
